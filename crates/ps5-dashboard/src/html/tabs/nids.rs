...
<div class="section"><h2>Top 10 Unknown NIDs</h2><p style="color:#8b949e;font-size:0.82rem;margin-bottom:12px">Unresolved imports ranked by occurrence — stub-implementation candidates</p><div id="unknownNidTop"></div></div>
